...
const HomeD = () => {
  ...
  return (
    <div className='fixed z-10 container mx-auto flex flex-col w-full h-full items-start justify-start py-4 px-3'>
        <div className='relative overflow-hidden  flex items-center justify-center text-white rounded-md text-center px-5 py-2 border border-blue-500 gap-1 group cursor-pointer'
        ...
        {
            visible && (
                <div className=' w-full flex-1 h-full pb-10 mt-4 flex items-start justify-start '>
