...
const Dashboard = () => {
  ...
  return (
    <div className='w-screen h-screen pt-16 lg:pt-16 flex items-start justify-start'>
        <div className='fixed lg:top-16 top-16  h-full shadow-md w-12 bg-slate-100'>
        ...
        <div className='flex flex-1 w-full h-full items-start pl-16 pr-3 py-2 '>
            <Outlet />
        </div>
    </div>
  )
